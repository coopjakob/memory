...
context('show 3 rows of products', () => {
  ...
  it('tiny phone show 6 cards', () => {
    ...
    cy.visit('/')
    cy.get('#main .card').should('have.length', 6)
